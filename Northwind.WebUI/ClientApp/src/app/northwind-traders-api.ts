...
export interface IProductsClient {
    getAll(filters: string | null, sorts: string | null, page: number | null, pageSize: number | null): Observable<ProductsListViewModel | null>;
...
export class ProductsClient implements IProductsClient {
    ...
    getAll(filters: string | null, sorts: string | null, page: number | null, pageSize: number | null): Observable<ProductsListViewModel | null> {
        ...
        if (filters === undefined)
            throw new Error("The parameter 'filters' must be defined.");
        else
            url_ += "Filters=" + encodeURIComponent("" + filters) + "&"; 
        if (sorts === undefined)
            throw new Error("The parameter 'sorts' must be defined.");
        else
